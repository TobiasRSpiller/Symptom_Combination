...
##PHQ
freq1_top_PHQ_color_top <- freq1_top_PHQ9 %>% 
  top_n(n=50) %>% 
  mutate(color = "#F97134")
...
##PANSS
freq1_top_PANSS_color_top <- freq1_top_Sz_DSM %>% 
  top_n(n=50) %>% 
  mutate(color = "#F97134")

B3 <- ggplot(freq1_top_PANSS_color_top, aes(x=as.factor(1:nrow(freq1_top_PANSS_color_top)),y=freq)) +
...
##GAD-7
freq1_top_GAD_color <- freq1_top_GAD7 %>% 
  top_n(n=50) %>% 
  mutate(color = "#F97134")
